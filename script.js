...
1: { title: "🖼️ BITMAP (Gambar Raster)", slides: [
    "📌 <strong>Pengertian Bitmap</strong><br><br>Bitmap adalah gambar yang tersusun dari titik-titik warna yang disebut <strong style='color:#c084fc'>PIKSEL</strong>. Setiap piksel memiliki lokasi dan warna tersendiri sehingga secara keseluruhan membentuk sebuah tampilan gambar.<br><br><div style='text-align:center; margin:20px 0;'><img src='Bitmap.jpg' style='width:300px; height:200px; object-fit:cover; border-radius:16px; border:3px solid #c084fc; box-shadow:0 5px 20px rgba(0,0,0,0.3);' onerror=\"this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 300 200%22%3E%3Crect width=%22300%22 height=%22200%22 fill=%22%23333%22/%3E%3Ctext x=%22150%22 y=%22100%22 text-anchor=%22middle%22 fill=%22%23c084fc%22%3EBitmap%3C/text%3E%3C/svg%3E'\"><br><small style='color:#c084fc;'>📸 Contoh gambar Bitmap - tersusun dari titik-titik piksel</small></div><br><strong>✨ Karakteristik Bitmap:</strong><br>• Tersusun dari kumpulan piksel<br>• Jika diperbesar akan terlihat kotak-kotak (pecah/pixelated)<br>• Ukuran file tergantung resolusi (semakin tinggi resolusi, semakin besar ukuran)<br>• Bersifat <strong>resolution dependent</strong> (kualitas tergantung DPI)<br>• Cocok untuk foto, gambar realistis, dan hasil scan",
...
2: { title: "✏️ VEKTOR (Gambar Garis & Kurva)", slides: [
    "📌 <strong>Pengertian Vektor</strong><br><br>Vektor adalah gambar yang tersusun dari <strong style='color:#c084fc'>garis, kurva, dan titik (anchor point)</strong> berdasarkan rumus matematika. Bukan dari piksel seperti bitmap.<br><br><div style='text-align:center; margin:20px 0;'><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Ai10_illustrator_splash.png/800px-Ai10_illustrator_splash.png' style='width:300px; height:200px; object-fit:contain; border-radius:16px; border:3px solid #c084fc; box-shadow:0 5px 20px rgba(0,0,0,0.3);' onerror=\"this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 300 200%22%3E%3Crect width=%22300%22 height=%22200%22 fill=%22%23333%22/%3E%3Ctext x=%22150%22 y=%22100%22 text-anchor=%22middle%22 fill=%22%23c084fc%22%3EVektor%3C/text%3E%3C/svg%3E'\"><br><small style='color:#c084fc;'>📐 Contoh gambar Vektor - tersusun dari garis dan kurva</small></div><br><strong>✨ Karakteristik Vektor:</strong><br>• Tersusun dari garis dan kurva matematis<br>• <strong>Tidak pernah pecah</strong> meskipun diperbesar berkali-kali (scalable)<br>• Ukuran file kecil karena hanya menyimpan data matematika<br>• Bersifat <strong>resolution independent</strong> (tidak tergantung DPI)<br>• Mudah diedit (bentuk, warna, ukuran bisa diubah)",
